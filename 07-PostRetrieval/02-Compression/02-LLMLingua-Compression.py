...
compressed_prompt = llm_lingua.compress_prompt(
    context="Yungang Grottoes位于中国北部山西省大同市西郊17公里处的武周山南麓,石窟依山开凿,东西绵延1公里。存有主要洞窟45个,大小窟龛252个,石雕造像51000余躯,为中国规模最大的古代石窟群之一,与敦煌莫高窟、洛阳龙门石窟和天水麦积山石窟并称为中国四大石窟艺术宝库。 1961年被国务院公布为全国首批重点文物保护单位,2001年12月14日被联合国教科文组织列入世界遗产名录,2007年5月8日被国家旅游局评为首批国家5A级旅游景区。……",
    instruction="压缩并保持主要内容",
    question="",
    target_token=10  # setup目标token数
)
...
json_data = {
    "id": 987654,
    "name": "Wukong",
    "biography": "孙Wukong，法号行者，是中国古典神魔小说《journey to the west》中的主要角色之一。孙Wukong由开天辟地以来的仙石孕育而生，因拜菩提祖师为师学会地煞数七十二变，又从龙宫索取如意金箍棒作为兵器，因大闹天宫被如来佛祖压在五行山下，无法行动。五百年后唐僧西天取经，路过五行山，揭去符咒，才救下孙Wukong。孙Wukong感激涕零，经观世音菩萨点拨，拜唐僧为师，同往西天取经。"
}
