...
# ——————————————
# 1. Create a Collection (quick setup mode)
# ——————————————
# Check for and delete an existing collection
...
if new_collection_name in client.list_collections():
    ...
    print(f"✓ Deleted the existing collection {new_collection_name}")
...
# ——————————————
# 6. Drop a Collection property (TTL)
# ——————————————
client.drop_collection_properties(
    collection_name=new_collection_name,
    property_keys=["collection.ttl.seconds"]
)
print(f"✓ Removed the TTL property from {new_collection_name}")

# ——————————————
# 7. Load & check the load state
# ——————————————
...
# ——————————————
# 8. Release & check the state after release
# ——————————————
...
# 9.3 Check whether a Partition exists
exists = client.has_partition(
    collection_name=new_collection_name,
    partition_name="partA"
)
print("Does partA exist?", exists)

# 9.4 Load & release a specific Partition
...
# 9.5 Drop a Partition (must be released first)
