...
# 9. Core flow: natural language -> SQL -> execute -> return
def text2sql(question: str):
    # 9.1 Embed the user's question
    ...
    # 9.4 RAG retrieval: column descriptions
    ...
    # 9.7 Execute and print the results
    try:
