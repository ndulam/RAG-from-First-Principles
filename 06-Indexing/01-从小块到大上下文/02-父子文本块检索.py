...
game_knowledge = """
《Destruction of Gods∙猢狲》是一款动作角色扮演游戏。游戏背景setup在架空的神话世界中。玩家将扮演齐天大圣孙Wukong，在充满东方神话元素的世界中展开冒险。游戏的战斗系统极具特色，采用了独特的"变身系统"。Wukong可以在战斗中变换不同形态。每种形态都有其独特的战斗风格和技能组合。金刚形态侧重力量型打击，带来压倒性的破坏力。魔佛形态则专注法术攻击，能释放强大的法术伤害。游戏世界中充满了标志性的神话角色，除了主角孙Wukong以外，还有来自佛教、道教等各派系的神魔。这些角色既可能是Wukong的盟友，也可能是需要击败的强大对手。装备系统包含了丰富的武器选择，除了著名的如意金箍棒以外，Wukong还可以使用各种神器法宝。不同武器有其特色效果，玩家需要根据战斗场景灵活选择。游戏的画面表现极具东方美学特色，场景融合了水墨画风格，将山川、建筑等元素完美呈现。战斗特效既有中国传统文化元素，又具备现代游戏的视觉震撼力。难度设计上，Boss战充满挑战性，需要玩家精准把握战斗节奏和技能运用。同时游戏也提供了多种难度选择，照顾不同技术水平的玩家。
